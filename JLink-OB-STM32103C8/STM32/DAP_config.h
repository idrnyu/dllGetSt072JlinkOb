...
// USART Port and I/O Pins
 ...
 ||   defined ( BOARD_STM32RF )
	...
	#define USART_CLOCK(state)		RCC_APB1PeriphClockCmd(RCC_APB1Periph_USART3, state)
	#define USART_GPIO_CLOCK(state)	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB, state)
